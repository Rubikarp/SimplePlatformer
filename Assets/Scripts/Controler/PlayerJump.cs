...
public class PlayerJump : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        //Gravit� = Physics2D.gravity.y * gravityScale = gravityForce
        //Gravit� = gravityForce / Physics2D.gravity.y
        //Et comme Physics2D.gravity.y est n�gatif, on l'inverse en mettant un - devant
        newGravityScale /= -Physics2D.gravity.y;
        currentGravityMultiplier = newGravityScale;
        body.gravityScale = currentGravityMultiplier;

        //Limite la velocit� terminal (la vitesse de chute maximum)
    ...
    {
        //Formule de physique :
        //Hauteur = (1/2) * Gravit� * Temps�
        //Donc Gravit� = (2 * Hauteur) / Temps�
